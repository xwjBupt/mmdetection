...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F0/epoch_1000.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
test_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/ai/mnt/data/stenosis/selected/Binary/FOLD0/annotations/train_binary.json',
    metric='bbox',
    backend_args=None)
max_epochs = 1000
num_last_epochs = 50
...
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F0/Show_epoch_1000_train'
