...
env_cfg = dict(
    ...
    git_info=
    'COMMIT TAG [\nyolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F2/fold2\nCOMMIT BRANCH >>> stenosis <<< \nCOMMIT ID >>> 796792b040f3f8bb22a4fed0353ed84199c4920e <<<]\n'
)
vis_backends = [
    dict(
    ...
    vis_backends=[
        dict(
            ...
            init_kwargs=dict(
                ...
                name='fold2',
                group='yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F2'))
    ],
    name='visualizer')
log_processor = dict(type='LogProcessor', window_size=50, by_epoch=True)
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F2/epoch_1000.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/ai/mnt/data/stenosis/selected/Binary/FOLD2/annotations/val_binary.json',
    metric='bbox',
    backend_args=None)
test_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/ai/mnt/data/stenosis/selected/Binary/FOLD2/annotations/train_binary.json',
    metric='bbox',
    backend_args=None)
max_epochs = 1000
num_last_epochs = 50
...
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F2/Show_epoch_1000_train'
