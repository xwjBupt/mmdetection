...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F2/best_coco_bbox_mAP_epoch_550.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F2/best_coco_bbox_mAP_Show_epoch_550_test'
