...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_1000e_lr5e-2_stenosis_binary/epoch_1000.pth'
resume = False
data_preprocessor = dict(
    type='DetDataPreprocessor',
    mean=[144.5754766729963, 144.5754766729963, 144.5754766729963],
    ...
    pad_size_divisor=32)
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_1000e_lr5e-2_stenosis_binary/Show_epoch_1000_train'
