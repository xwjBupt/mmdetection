...
env_cfg = dict(
    ...
    git_info=
    'COMMIT TAG [\nyolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F1/fold1\nCOMMIT BRANCH >>> stenosis <<< \nCOMMIT ID >>> 6eee8532893ae2d31d0eba0aafb3fb0857fe1a94 <<<]\n'
)
vis_backends = [
    dict(
    ...
    vis_backends=[
        dict(
            ...
            init_kwargs=dict(
                ...
                name='fold1',
                group='yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F1'))
    ],
    name='visualizer')
log_processor = dict(type='LogProcessor', window_size=50, by_epoch=True)
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F1/epoch_1000.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
data_root = '/ai/mnt/data/stenosis/selected/Binary/FOLD1/'
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/ai/mnt/data/stenosis/selected/Binary/FOLD1/annotations/val_binary.json',
    metric='bbox',
    backend_args=None)
test_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/ai/mnt/data/stenosis/selected/Binary/FOLD1/annotations/train_binary.json',
    metric='bbox',
    backend_args=None)
max_epochs = 1000
num_last_epochs = 50
...
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary_F1/Show_epoch_1000_train'
