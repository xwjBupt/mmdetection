...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary/best_coco_bbox_mAP_epoch_120.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
warm_epoch = 50
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary/best_coco_bbox_mAP_Show_epoch_120_test'
