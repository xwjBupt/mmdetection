...
env_cfg = dict(
    ...
    git_info=
    'COMMIT TAG [\nyolox_l_8xb8-1000e-lr5e-2_stenosis_binary/1000epoch-lr5e-2-baserun_binary\nCOMMIT BRANCH >>> stenosis <<< \nCOMMIT ID >>> b1c5a0808a5ee16f113b7521549b30147e40000e <<<]\n'
)
vis_backends = [
    dict(
    ...
    vis_backends=[
        dict(
            ...
            init_kwargs=dict(
                ...
                name='1000epoch-lr5e-2-baserun_binary',
                group='yolox_l_8xb8-1000e-lr5e-2_stenosis_binary'))
    ],
    name='visualizer')
log_processor = dict(type='LogProcessor', window_size=50, by_epoch=True)
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary/epoch_1000.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
test_evaluator = dict(
    type='CocoMetric',
    ann_file='/ai/mnt/data/stenosis/selected/annotations/train_binary.json',
    metric='bbox',
    backend_args=None)
max_epochs = 1000
num_last_epochs = 50
...
warm_epoch = 50
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-1000e-lr5e-2_stenosis_binary/Show_epoch_1000_train'
