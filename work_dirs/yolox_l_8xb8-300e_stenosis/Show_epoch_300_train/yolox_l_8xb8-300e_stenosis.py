...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-300e_stenosis/epoch_300.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
val_dataset = dict(
    ...
    data_prefix=dict(img='val/'))
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-300e_stenosis/Show_epoch_300_train'
