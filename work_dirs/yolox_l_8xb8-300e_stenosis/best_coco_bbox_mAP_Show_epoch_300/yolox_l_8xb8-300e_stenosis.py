...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        draw=True,
        test_out_dir=
        '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-300e_stenosis/best_coco_bbox_mAP_Show_epoch_300'
    ))
env_cfg = dict(
...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-300e_stenosis/best_coco_bbox_mAP_epoch_300.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
val_dataset = dict(
    ...
    data_prefix=dict(img='val/'))
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-300e_stenosis/best_coco_bbox_mAP_Show_epoch_300'
