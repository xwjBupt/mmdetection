...
env_cfg = dict(
    ...
    git_info=
    'COMMIT TAG [\nyolox_l_8xb8-300e_stenosis_binary/300epoch-baserun_binary\nCOMMIT BRANCH >>> stenosis <<< \nCOMMIT ID >>> e1eba8a66f158a89e4896b884f932039c2be0057 <<<]\n'
)
vis_backends = [
    dict(
    ...
    vis_backends=[
        dict(
            ...
            init_kwargs=dict(
                ...
                name='300epoch-baserun_binary',
                group='yolox_l_8xb8-300e_stenosis_binary'))
    ],
    name='visualizer')
log_processor = dict(type='LogProcessor', window_size=50, by_epoch=True)
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-300e_stenosis_binary/epoch_300.pth'
resume = False
tta_model = dict(
    type='DetTTAModel',
...
val_dataset = dict(
    ...
    data_prefix=dict(img='val/'))
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/yolox_l_8xb8-300e_stenosis_binary/Show_epoch_300_train'
