...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        draw=True,
        test_out_dir=
        '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/Show_epoch_485'
    ))
env_cfg = dict(
...
max_epochs = 500
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/Show_epoch_485'
