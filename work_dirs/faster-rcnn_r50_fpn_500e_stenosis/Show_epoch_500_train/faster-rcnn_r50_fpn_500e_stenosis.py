...
test_evaluator = dict(
    type='CocoMetric',
    ann_file='/ai/mnt/data/stenosis/selected/annotations/train_multi.json',
    metric='bbox',
    format_only=False,
    backend_args=None)
max_epochs = 500
...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/epoch_500.pth'
resume = False
data_preprocessor = dict(
    type='DetDataPreprocessor',
    mean=[144.5754766729963, 144.5754766729963, 144.5754766729963],
    ...
    pad_size_divisor=32)
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/Show_epoch_500_train'
