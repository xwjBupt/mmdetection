...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        draw=True,
        test_out_dir=
        '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/Show_epoch_22'
    ))
env_cfg = dict(
...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/epoch_22.pth'
resume = False
data_preprocessor = dict(
    type='DetDataPreprocessor',
    mean=[144.5754766729963, 144.5754766729963, 144.5754766729963],
...
max_epochs = 500
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/Show_epoch_22'
