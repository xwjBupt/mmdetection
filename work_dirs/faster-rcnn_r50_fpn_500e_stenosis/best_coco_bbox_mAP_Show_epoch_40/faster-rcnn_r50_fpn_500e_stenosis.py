...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='/ai/mnt/data/stenosis/selected/annotations/val.json',
    metric='bbox',
    format_only=False,
    backend_args=None)
test_evaluator = dict(
...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        draw=True,
        test_out_dir=
        '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/best_coco_bbox_mAP_Show_epoch_40'
    ))
env_cfg = dict(
    ...
    vis_backends=[
        dict(
            ...
            init_kwargs=dict(
                ...
                group='faster-rcnn_r50_fpn_500e_stenosis'))
    ],
    name='visualizer')
log_processor = dict(type='LogProcessor', window_size=50, by_epoch=True)
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/best_coco_bbox_mAP_epoch_40.pth'
resume = False
data_preprocessor = dict(
    type='DetDataPreprocessor',
    mean=[144.5754766729963, 144.5754766729963, 144.5754766729963],
    ...
    pad_size_divisor=32)
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/faster-rcnn_r50_fpn_500e_stenosis/best_coco_bbox_mAP_Show_epoch_40'
