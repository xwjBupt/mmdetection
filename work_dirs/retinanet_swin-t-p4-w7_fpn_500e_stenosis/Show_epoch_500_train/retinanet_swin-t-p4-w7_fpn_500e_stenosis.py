...
log_level = 'INFO'
load_from = '/ai/mnt/code/mmdetection/work_dirs/retinanet_swin-t-p4-w7_fpn_500e_stenosis/epoch_500.pth'
resume = False
...
data_preprocessor = dict(
    ...
    pad_size_divisor=32)
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/retinanet_swin-t-p4-w7_fpn_500e_stenosis/Show_epoch_500_train'
