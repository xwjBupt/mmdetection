...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        draw=True,
        test_out_dir=
        '/ai/mnt/code/mmdetection/work_dirs/retinanet_swin-t-p4-w7_fpn_500e_stenosis/best_coco_bbox_mAP_Show_epoch_110'
    ))
env_cfg = dict(
...
data_preprocessor = dict(
    ...
    pad_size_divisor=32)
launcher = 'none'
work_dir = '/ai/mnt/code/mmdetection/work_dirs/retinanet_swin-t-p4-w7_fpn_500e_stenosis/best_coco_bbox_mAP_Show_epoch_110'
